...
KATEGORI_ANAHTAR_KELIMELERI: dict[str, list[str]] = {
    ...
    "Idare Hukuku": [
        "devlet", "belediye", "kamu", "idare",
        "lisans", "ruhsat", "izin belgesi", "kamulistirma", "kamulastirma",
        ...
        "idari yargi", "idari dava", "idari karar",
    ],
    "Vergi Hukuku": [
    ...
    "Sosyal Guvenlik Hukuku": [
        ...
        "prim gun", "sigorta", "is kazasi", "meslek hastaligi",
        "malulluk", "yaslilik", "olum ayligi", "dul ayligi",
        "yetim ayligi", "borclanma", "hizmet tespit",
        "saglik sigortasi", "genel saglik", "istirahat raporu",
        "gecici is goremezlik", "surekli is goremezlik",
    ],
    "Ticaret Hukuku": [
