...
LAW_NUMBERS = (
    "193", "213", "634", "657", "1136", "1475",
    "2004", "2577", "2709", "2911", "2918", "2942",
    "3065", "3071", "3194",
    "4447", "4721", "4734", "4857", "4904", "4982",
    "5070", "5237", "5253", "5271", "5326", "5352", "5411", "5510",
    "5520", "5651", "5846", "5901",
    "6098", "6100", "6102", "6183", "6284", "6306", "6325",
    "6331", "6356", "6362", "6458", "6502", "6698", "6735", "6769",
    "7036", "7201",
)
...
LAW_HINT_KEYWORDS = {
    ...
    "1475": {"kidem", "kidem_tazminat", "tazminat", "kidem_hakki"},
    ...
    "5237": {"suc", "ceza", "hapis", "adli", "kovusturma", "beraat", "mahkumiyet",
             ...
             "cinayet", "sahtecilik", "zimmet", "irtikap", "rusvet", "aldatma",
             "cinsel", "konut", "kisi", "ozgurlu"},
    "5271": {"ceza_muhakeme", "tutuklama", "gozalti", "iddianame", "savci",
             "durusma", "tahliye", "yargilama", "sorgulama", "mudafi",
             "uzlasma", "uyusturma", "kovusturma", "arama", "elkoyma"},
    "4721": {"medeni", "velayet", "bosanma", "nafaka", "evlilik", "nikah", "miras",
             "veraset", "aile", "cocuk", "vesayet", "kayyum", "mal_rejimi",
             "hisim", "evlat", "tanima", "soyadi", "mulkiyet", "tasinmaz"},
    "6502": {"tuketici", "ayipli", "garanti", "iade", "cayma", "mesafeli",
             "e_ticaret", "online", "kampanya", "haksiz_sart", "fatura",
             "teslim", "abonelik", "devre_mulk", "paket_tur", "tuketici_hakem",
             "tuketici_mahkeme", "tuketici_hakları", "satis", "urun", "hizmet",
             "taksit", "konut", "siparis", "kargo"},
    ...
    "657":  {"memur", "devlet_memur", "kamu_gorevli", "disiplin", "ihrac",
             ...
             "gorev", "unvan", "kadro"},
    "213":  {"vergi_usul", "defter", "muhasebe", "fatura", "kayit", "yoklama",
             "inceleme", "tarh", "teblig", "ceza_kesme", "vergi_cezasi",
             "usulsuzluk", "vergi_sucu", "pismanlık", "uzlasma", "duzeltme",
             "takdir", "vergi_inceleme", "mükellef", "belge", "fiş"},
    "6183": {"amme_alacak", "odeme_emri", "haciz", "tecil", "taksitlendirme",
             "vergi_borcu", "kamu_alacak", "ihtiyati_haciz", "ödeme_emri",
             "gecikme_zammi"},
    "2577": {"idare", "idari_islem", "iptal_dava", "idare_mahkeme",
             "yurutmeyi_durdurma", "idari_yargi", "danistay", "tam_yargi",
             "idari_islem_iptali", "idari_dava", "idari_yargilama"},
    "6698": {"kvkk", "kisisel_veri", "veri_sorumlusu", "acik_riza",
             "veri_isleme", "unutulma", "veri_ihlali", "kurul",
             "kisisel_verilerin_korunmasi", "veri_aktarim", "aydinlatma",
             "riza", "gizlilik"},
    "6769": {"marka", "patent", "endustriyel_tasarim", "faydali_model",
             "cografi_isaret", "sinai", "sinai_mulkiyet", "marka_tescil",
             "patent_basvuru", "tasarim", "buluş", "tescil", "marka_hakki",
             "patent_hakki", "fikri", "mulkiyet_hakki"},
    ...
    "5901": {"vatandaslik", "vatandas", "vatandasliktan", "tabiiyet",
             "uyruk", "turk_vatandas", "cift_vatandaslik", "mavi_kart"},
    ...
    "2004": {"icra", "haciz", "borclu", "alacakli", "iflas", "tahliye",
    ...
    "5520": {"kurumlar_vergisi", "sirket_vergi", "beyanname", "kar",
             "zarar", "ortulu_kazanc"},
    ...
    "5846": {"telif", "fikir_eseri", "eser_sahibi", "koruma", "izin",
             "lisans", "intihal"},
    "634":  {"kat_mulkiyeti", "kat_irtifaki", "apartman", "yonetim_plani",
             "aidat", "ortak_alan", "site", "daire", "bina_yonetimi"},
    "1136": {"avukat", "baro", "avukatlik", "vekalet", "vekaletname",
             "avukatlik_ucreti", "savunma"},
    "5326": {"kabahat", "idari_para_cezasi", "idari_yaptirim"},
    "5352": {"adli_sicil", "sabika", "sicil_kaydi", "arsiv_kaydi"},
    "6284": {"siddet", "uzaklastirma", "tedbir", "kadin", "aile_ici"},
    "6325": {"arabuluculuk", "arabulucu", "uzlasma", "uyusmazlik"},
    "6362": {"sermaye_piyasasi", "borsa", "hisse_senedi", "tahvil",
             "spk", "araci_kurum"},
    "6458": {"yabanci", "oturma_izni", "calisma_izni", "sinir_disi",
             "multeci", "iltica", "goc", "uluslararasi_koruma"},
    "6735": {"isgücu", "yabanci_calisma", "calisma_izni"},
    "4982": {"bilgi_edinme", "basvuru", "kurum_bilgi", "red"},
    "2942": {"kamulastirma", "istimlak", "bedel", "tasinmaz"},
    "3071": {"dilekce", "basvuru_hakki", "sikayet", "talep"},
    "5411": {"banka", "kredi", "faiz", "tuketici_kredisi", "mortgage",
             "teminat", "bddk"},
    "5253": {"dernek", "uyelik", "tuzel_kisi", "genel_kurul"},
    "4904": {"iskur", "is_bul", "mesleki_egitim"},
    "5070": {"elektronik_imza", "e_imza", "nitelikli"},
    "3194": {"imar", "insaat_ruhsat", "yapi", "imar_plani"},
...
KATEGORI_EXPECTED_LAWS: dict[str, set[str]] = {
    "İş Hukuku":       {"4857", "1475", "5510", "7036", "6331", "6356", "4447", "4904", "6325"},
    "Medeni Hukuk":    {"4721", "6098", "6284", "634"},
    "Ceza Hukuku":     {"5237", "5271", "5352", "6284"},
    "Ticaret Hukuku":  {"6102", "5411", "6362", "2004"},
    "Tüketici Hukuku": {"6502", "6098", "6102"},
    "Taşınmaz Mülk":   {"4721", "2942", "3194", "6306", "6098", "634"},
    "İdare Hukuku":    {"2577", "2709", "657", "4734", "5326"},
    "Vergi Hukuku":    {"193", "213", "3065", "5520", "6183", "2577"},
    "Sosyal Güvenlik": {"5510", "4447", "4904", "6331"},
    "Fikri Mülkiyet":  {"5846", "5070", "6769"},
    "Bilişim":         {"5651", "6698", "5237", "5070"},
    "Anayasa":         {"2709", "2911", "5253"},
    "Usul Hukuku":     {"6100", "2004", "7201", "7036", "2577", "6325", "1136"},
}
